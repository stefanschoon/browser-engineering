...
from app.layout import WIDTH, HEIGHT, get_font
...
class Browser:
    ...
    def draw(self):
        ...
        self.canvas.create_rectangle(0, 0, WIDTH, CHROME_PX, fill=CHROME_FILL, outline=CHROME_OUTLINE)
        ...
        for i, tab in enumerate(self.tabs):
            ...
            if i == self.active_tab:
                ...
                self.canvas.create_line(x2, 40, WIDTH, 40, fill=CHROME_OUTLINE)
        ...
        self.canvas.create_rectangle(40, 50, WIDTH - 10, 90, outline=CHROME_OUTLINE, width=1)
    ...
    def handle_click(self, event):
        ...
        if event.y < CHROME_PX:
            ...
            elif 50 <= event.x < WIDTH - 10 and 40 <= event.y < 90:
